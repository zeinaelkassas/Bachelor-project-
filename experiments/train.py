...
if __name__ == "__main__":
    ...
    parser.add_argument('--new_set', type=str, default='new-set/')
    parser.add_argument('--augment_preemphasis', type=str, default='False')
    ...
    dict_args = vars(args)
    # exitdata_module.val_dataloader
    # create data module
    ...
    trainer.validate(model=experiment, val_dataloaders=data_module.val_dataloader_new())
    # train
